...
public class TestCase03 extends BaseTest {
    ...
    public void TC03() {
        ExtentTest test = Constant.EXTENT.createTest("TC03 - User cannot log into Railway with invalid password");
        ...
        String actualMsg = loginPage.login(Constant.USERNAME, "").getLoginErrorMessage();
        test.log(Status.INFO, "3. Enter valid Email and invalid Password");
